    ...
    
    {
           ...
           console.log(topicmanager);
            if(err)
             ...
             //correspong subject add to in topicmanager
             else
             {
              topicuser.find({_id:topicmanager.subject},function(err,response2)
              {
                correspondingtopic=response2;
                console.log("correspondingtopic"+ correspondingtopic);
               topicuser.find(function(err,response3)
               {
                  if(err)
                      res.send(err)
                  else
